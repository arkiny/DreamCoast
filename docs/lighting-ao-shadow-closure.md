...
## 8. 신규 개방 항목 — TAAU 이동 블러

사용자 보고: 이동 중 TAA 블러 과다. 진단·계획 완비:
**docs/phase-taau-motion-sharpness-prompt.md** (빌리니어 히스토리 리샘플이 주범,
Catmull-Rom + 속도-게이트 블렌드 정책 처방, 셔머 래칫 동시 유지 게이트).
